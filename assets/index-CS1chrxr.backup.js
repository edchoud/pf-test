            ...
            className:"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5",children:nS.map((n,r)=>{
              ...
              return o?p.jsx("div",{
                className:"animate-fade-in-up",style:{
                  ...
                  title:o.title,description:o.description,tags:o.tags,slug:rS[n]||n,image:oS[n],location:"location"in o?o.location:void 0,isLocked:n==="stellaris-ftue"
                })
              },n):null
            })
          })
