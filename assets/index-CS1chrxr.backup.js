...
function Uk(e,t){
  ...
  if(n==="decathlon-wizard")return p.jsxs("main",{className:"min-h-screen",children:[p.jsx("section",{className:"pt-12 pb-8 md:pt-16 md:pb-12",children:p.jsxs("div",{className:"container-content",children:[p.jsx("div",{className:"mb-8",children:p.jsx(Ya,{})}),p.jsxs("div",{className:"animate-fade-in-up",children:[p.jsx("h1",{className:"heading-case mb-4",children:o.heroTitle}),p.jsx("div",{className:"flex flex-wrap gap-2 mb-6",children:i.tags.map((u,c)=>p.jsx("span",{className:"px-3 py-1.5 text-sm font-medium rounded-lg bg-foreground text-background",children:u},c))}),p.jsx("p",{className:"body-large text-muted-foreground max-w-3xl",children:o.heroSubtitle})]})]})}),p.jsx("section",{className:"py-16 md:py-20 border-t border-border",children:p.jsxs("div",{className:"container-content",children:[p.jsx("p",{className:"body-base text-muted-foreground max-w-2xl mb-12",children:o.ataGlance.intro}),p.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-4 gap-x-8 gap-y-10 mb-16",children:[p.jsxs("div",{children:[p.jsx("span",{className:"label-caps text-muted-foreground/60 block mb-4",children:"My role"}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed",children:o.ataGlance.myRole})]}),p.jsxs("div",{children:[p.jsx("span",{className:"label-caps text-muted-foreground/60 block mb-4",children:"Timeline"}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed",children:o.ataGlance.timeline})]}),p.jsxs("div",{children:[p.jsx("span",{className:"label-caps text-muted-foreground/60 block mb-4",children:"Team"}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed",children:o.ataGlance.team})]}),p.jsxs("div",{children:[p.jsx("span",{className:"label-caps text-muted-foreground/60 block mb-4",children:"Tools"}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed",children:o.ataGlance.tools})]})]}),p.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[p.jsxs("div",{children:[p.jsx("span",{className:"label-caps text-muted-foreground/60 block mb-3",children:"Before"}),p.jsx("div",{className:"rounded-xl overflow-hidden",children:p.jsx("img",{src:DWb,alt:"Before — old Partner monolithic form",className:"w-full h-auto"})})]}),p.jsxs("div",{children:[p.jsx("span",{className:"label-caps text-muted-foreground/60 block mb-3",children:"After"}),p.jsx("div",{className:"rounded-xl overflow-hidden",children:p.jsx("img",{src:DWa,alt:"After — wizard step with progress bar",className:"w-full h-auto"})})]})]})]})}),p.jsx("section",{className:"py-16 md:py-20 border-t border-border",children:p.jsxs("div",{className:"container-content",children:[p.jsx("h2",{className:"heading-section mb-12",children:"The genesis"}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed max-w-3xl mb-12",children:o.genesis[0].body}),p.jsx("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6",children:o.genesis.slice(1).map((u,c)=>p.jsxs("div",{className:"p-6 rounded-xl border border-border bg-card",children:[p.jsx("h3",{className:"font-medium text-foreground mb-3",children:u.title}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed",children:u.body})]},c))})]})}),p.jsx("section",{className:"py-16 md:py-20 border-t border-border",children:p.jsx("div",{className:"container-content",children:p.jsx("div",{className:"grid grid-cols-1 md:grid-cols-4 gap-6",children:o.kpis.map((u,c)=>p.jsxs("div",{className:"p-6 rounded-xl border border-border bg-card",children:[p.jsx("p",{className:"text-3xl font-bold mb-2",style:{color:u.color},children:u.value}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed",children:u.description})]},c))})})}),p.jsx("section",{className:"py-16 md:py-20 border-t border-border",children:p.jsx("div",{className:"container-content",children:p.jsx("div",{className:"max-w-3xl",children:o.timeline.map((u,c)=>p.jsxs("div",{children:[u.hasDivider&&p.jsxs("div",{className:"flex items-center gap-4 my-8",children:[p.jsx("div",{className:"flex-1 h-px bg-border"}),p.jsx("span",{className:"label-caps text-muted-foreground/60 px-3",children:"Project"}),p.jsx("div",{className:"flex-1 h-px bg-border"})]}),p.jsxs("div",{className:"flex gap-6 pb-8 "+(u.dimmed?"opacity-40":""),children:[p.jsxs("div",{className:"flex flex-col items-center flex-shrink-0",children:[p.jsx("div",{className:"w-7 h-7 rounded-full border-2 border-border flex items-center justify-center text-xs font-medium text-muted-foreground",children:c+1}),c<o.timeline.length-1&&p.jsx("div",{className:"w-px flex-1 min-h-8 bg-border mt-2"})]}),p.jsxs("div",{className:"pb-2",children:[p.jsx("h3",{className:"font-medium text-foreground mb-2",children:u.title}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed",children:u.body})]})]})]},c))})})}) ,p.jsx("section",{className:"py-16 md:py-20 border-t border-border",children:p.jsxs("div",{className:"container-content",children:[p.jsx("h2",{className:"heading-section mb-8",children:"Discovery & research"}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed max-w-2xl mb-4",children:o.discovery.problemStatement}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed max-w-2xl mb-4",children:o.discovery.context}),p.jsx("p",{className:"label-caps text-muted-foreground/60 mb-12",children:o.discovery.methods}),p.jsx("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6 mb-12",children:o.discovery.stats.map((u,c)=>p.jsxs("div",{className:"p-6 rounded-xl border border-border bg-card",children:[p.jsx("p",{className:"text-2xl font-bold text-foreground mb-2",children:u.value}),p.jsx("p",{className:"body-base text-muted-foreground",children:u.label})]},c))}),p.jsx("div",{className:"p-6 rounded-xl bg-muted/50 border border-border mb-12",children:p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed italic",children:o.discovery.advisorCallout})}),p.jsx("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6",children:o.discovery.insights.map((u,c)=>p.jsxs("div",{className:"p-6 rounded-xl border border-border bg-card",style:{borderTopColor:u.borderColor,borderTopWidth:"3px"},children:[p.jsx("h3",{className:"font-medium text-foreground mb-3",children:u.title}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed",children:u.body})]},c))})]})}),p.jsx("section",{className:"py-16 md:py-20 border-t border-border",children:p.jsxs("div",{className:"container-content",children:[p.jsx("h2",{className:"heading-section mb-8",children:"Design & delivery"}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed max-w-2xl mb-4",children:o.designDelivery.fromResearchToDirection}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed max-w-2xl mb-12",children:o.designDelivery.mandatoryWorkshop}),p.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6 mb-12",children:o.designDelivery.decisions.map((u,c)=>p.jsxs("div",{className:"p-6 rounded-xl border border-border bg-card",children:[p.jsx("h3",{className:"font-medium text-foreground mb-3",children:u.title}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed",children:u.body})]},c))}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed max-w-2xl mb-4",children:o.designDelivery.userTesting}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed max-w-2xl",children:o.designDelivery.workingWithDevs})]})}),p.jsx("section",{className:"py-16 md:py-20 border-t border-border",children:p.jsxs("div",{className:"container-content",children:[p.jsx("h2",{className:"heading-section mb-8",children:"Impact"}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed max-w-2xl mb-12",children:o.impact.opening}),p.jsx("div",{className:"grid grid-cols-1 md:grid-cols-4 gap-6 mb-12",children:o.kpis.map((u,c)=>p.jsxs("div",{className:"p-6 rounded-xl border border-border bg-card",children:[p.jsx("p",{className:"text-3xl font-bold mb-2",style:{color:u.color},children:u.value}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed",children:u.description})]},c))}),p.jsxs("div",{className:"mb-12",children:[p.jsx("div",{className:"space-y-4 mb-10",children:o.impact.barChart.map((u,c)=>p.jsxs("div",{className:"flex items-center gap-4",children:[p.jsx("span",{className:"text-xs font-mono text-muted-foreground/60 uppercase tracking-wider w-40 flex-shrink-0",children:u.label}),p.jsx("div",{className:"flex-1 bg-muted rounded-full h-1.5",children:p.jsx("div",{className:"bg-foreground h-1.5 rounded-full",style:{width:u.width}})}),p.jsx("span",{className:"body-base font-medium text-foreground w-20 text-right flex-shrink-0",children:u.value})]},c))}),p.jsx("div",{className:"rounded-xl overflow-hidden mt-8",children:p.jsx("img",{src:DWg,alt:"KPI growth dashboard",className:"w-full h-auto max-w-2xl"})})]}),p.jsx("div",{className:"pl-6 border-l-4 border-foreground mb-12",children:p.jsx("p",{className:"body-large text-muted-foreground italic leading-relaxed",children:o.impact.closingQuote})}),p.jsxs("div",{children:[p.jsx("span",{className:"label-caps text-muted-foreground/60 block mb-4",children:"What I\u2019d do differently"}),p.jsx("p",{className:"body-base text-muted-foreground leading-relaxed max-w-2xl",children:o.impact.whatIDoDifferently})]})]})}),p.jsx("footer",{className:"py-16 md:py-20 border-t border-border",children:p.jsxs("div",{className:"container-content",children:[p.jsxs("div",{className:"flex flex-col items-center text-center",children:[p.jsx("p",{className:"body-large text-muted-foreground mb-6 max-w-md",children:"Interested in working together?"}),p.jsxs("a",{href:"mailto:edouard.choudin@gmail.com",className:"btn-outline group",children:[p.jsx(Kl,{className:"w-4 h-4 mr-2 group-hover:text-background transition-colors"}),t.buttons.message]})]}),p.jsx("div",{className:"mt-12 pt-8 border-t border-border",children:p.jsx(Ya,{})})]})})]});
  return p.jsxs("main",{
