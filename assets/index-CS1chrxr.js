...
},Pg="/assets/Decathlon.png",Zk="/assets/footer-bg-Dnjp0JU9.png",eS="/assets/finoptima-card-CC-Lvjwg.png",tS="/assets/lectra-card-BWGKLK3J.png",nS=["decathlon-wizard","decathlon-travel","stellaris-cloaking","stellaris-ftue","selection"],rS={"decathlon-wizard":"decathlon-saas-wizard","stellaris-ftue":"stellaris-ftue","stellaris-cloaking":"stellaris-cloaking-feature-dlc","decathlon-travel":"decathlon-marketplace-cro-b2c"},oS={"decathlon-wizard":Pg,"stellaris-cloaking":eS,"decathlon-travel":tS},iS=()=>{
  const e=Jk(.15),{
    t
  }=vi();
            ...
            className:"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5",children:nS.map((n,r)=>{
              ...
              return o?p.jsx("div",{
                className:"animate-fade-in-up",style:{
                  ...
                  title:o.title,description:o.description,tags:o.tags,slug:rS[n]||n,image:oS[n],location:"location"in o?o.location:void 0,isLocked:n==="stellaris-ftue"||n==="selection"
                })
              },n):null
            })
          })
