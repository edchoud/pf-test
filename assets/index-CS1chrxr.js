      ...
      className:"min-h-screen pt-12 md:pt-16",children:[p.jsx("section",{
        id:"about",className:"py-6 md:py-8 bg-inherit",children:p.jsx("div",{
          className:"container-content",children:p.jsxs("div",{
            className:"flex flex-col-reverse md:flex-row gap-8 md:gap-16 items-center",children:[p.jsxs("div",{
            className:"max-w-3xl animate-fade-in-up flex-1",style:{
            ...
            style:{width:"clamp(120px, 20vw, 240px)",height:"clamp(120px, 20vw, 240px)",borderRadius:"50%",objectFit:"cover"}
          })]
        })
        })
      }),p.jsxs("section",{
